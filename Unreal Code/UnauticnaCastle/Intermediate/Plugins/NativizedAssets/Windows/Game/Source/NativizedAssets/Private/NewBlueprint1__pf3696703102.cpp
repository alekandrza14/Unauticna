...
#include "NewBlueprint1__pf3696703102.h"
...
ANewBlueprint1_C__pf3696703102::ANewBlueprint1_C__pf3696703102(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	bpv__untitled_Cylinder__pf = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("untitled_Cylinder"));
	bpv__untitled_Cube_001__pf = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("untitled_Cube_001"));
	bpv__untitled_Cube__pf = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("untitled_Cube"));
	bpv__Audio__pf = CreateDefaultSubobject<UAudioComponent>(TEXT("Audio"));
	bpv__untitled_Cylinder__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__untitled_Cylinder__pf->AttachToComponent(__Local__0, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__12 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__untitled_Cylinder__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__12 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ANewBlueprint1_C__pf3696703102::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	(((FBoolProperty*)__Local__13)->SetPropertyValue_InContainer((bpv__untitled_Cylinder__pf), true, 0));
	bpv__untitled_Cube_001__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__untitled_Cube_001__pf->AttachToComponent(bpv__untitled_Cylinder__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__15 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__untitled_Cube_001__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__15 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ANewBlueprint1_C__pf3696703102::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	(((FBoolProperty*)__Local__13)->SetPropertyValue_InContainer((bpv__untitled_Cube_001__pf), true, 0));
	bpv__untitled_Cube__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__untitled_Cube__pf->AttachToComponent(bpv__untitled_Cube_001__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__16 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__untitled_Cube__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__16 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ANewBlueprint1_C__pf3696703102::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	(((FBoolProperty*)__Local__13)->SetPropertyValue_InContainer((bpv__untitled_Cube__pf), true, 0));
	bpv__Audio__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__Audio__pf->AttachToComponent(bpv__untitled_Cube__pf, FAttachmentTransformRules::KeepRelativeTransform );
	bpv__Audio__pf->Sound = CastChecked<USoundBase>(CastChecked<UDynamicClass>(ANewBlueprint1_C__pf3696703102::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed);
	(((FBoolProperty*)__Local__13)->SetPropertyValue_InContainer((bpv__Audio__pf), false, 0));
...
void ANewBlueprint1_C__pf3696703102::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
	if(bpv__untitled_Cylinder__pf)
	{
		bpv__untitled_Cylinder__pf->CreationMethod = EComponentCreationMethod::Native;
	}
	if(bpv__untitled_Cube_001__pf)
	{
		bpv__untitled_Cube_001__pf->CreationMethod = EComponentCreationMethod::Native;
	}
	if(bpv__untitled_Cube__pf)
	{
		bpv__untitled_Cube__pf->CreationMethod = EComponentCreationMethod::Native;
	}
	if(bpv__Audio__pf)
...
PRAGMA_DISABLE_OPTIMIZATION
void ANewBlueprint1_C__pf3696703102::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ANewBlueprint1_C__pf3696703102::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{60, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  StaticMesh /Game/ThirdPersonBP/Blueprints/untitled_Cylinder.untitled_Cylinder 
		{61, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  StaticMesh /Game/ThirdPersonBP/Blueprints/untitled_Cube_001.untitled_Cube_001 
		{62, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  StaticMesh /Game/ThirdPersonBP/Blueprints/untitled_Cube.untitled_Cube 
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ANewBlueprint1_C__pf3696703102::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ANewBlueprint1_C__pf3696703102
{
	FRegisterHelper__ANewBlueprint1_C__pf3696703102()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/res/NewBlueprint1"), &ANewBlueprint1_C__pf3696703102::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ANewBlueprint1_C__pf3696703102 Instance;
};
FRegisterHelper__ANewBlueprint1_C__pf3696703102 FRegisterHelper__ANewBlueprint1_C__pf3696703102::Instance;

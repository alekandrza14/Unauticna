...
#include "NewBlueprint8__pf3696703102.h"
...
ANewBlueprint8_C__pf3696703102::ANewBlueprint8_C__pf3696703102(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	bpv__Shape_Cube__pf = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("Shape_Cube"));
	bpv__Shape_Cube__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__Shape_Cube__pf->AttachToComponent(__Local__0, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__12 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__Shape_Cube__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__12 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ANewBlueprint8_C__pf3696703102::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	(((FBoolProperty*)__Local__13)->SetPropertyValue_InContainer((bpv__Shape_Cube__pf), true, 0));
...
void ANewBlueprint8_C__pf3696703102::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
	if(bpv__Shape_Cube__pf)
	{
		bpv__Shape_Cube__pf->CreationMethod = EComponentCreationMethod::Native;
	}
}
PRAGMA_DISABLE_OPTIMIZATION
void ANewBlueprint8_C__pf3696703102::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ANewBlueprint8_C__pf3696703102::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{53, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  StaticMesh /Game/StarterContent/Shapes/Shape_Cube.Shape_Cube 
	};
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ANewBlueprint8_C__pf3696703102::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ANewBlueprint8_C__pf3696703102
{
	FRegisterHelper__ANewBlueprint8_C__pf3696703102()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/res/NewBlueprint8"), &ANewBlueprint8_C__pf3696703102::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ANewBlueprint8_C__pf3696703102 Instance;
};
FRegisterHelper__ANewBlueprint8_C__pf3696703102 FRegisterHelper__ANewBlueprint8_C__pf3696703102::Instance;

...
#include "NewBlueprint4__pf3696703102.h"
...
ANewBlueprint4_C__pf3696703102::ANewBlueprint4_C__pf3696703102(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	bpv__SM_Statue__pf = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("SM_Statue"));
	bpv__SM_Statue__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__SM_Statue__pf->AttachToComponent(__Local__0, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__12 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__SM_Statue__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__12 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ANewBlueprint4_C__pf3696703102::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	(((FBoolProperty*)__Local__13)->SetPropertyValue_InContainer((bpv__SM_Statue__pf), true, 0));
...
void ANewBlueprint4_C__pf3696703102::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
	if(bpv__SM_Statue__pf)
	{
		bpv__SM_Statue__pf->CreationMethod = EComponentCreationMethod::Native;
	}
}
PRAGMA_DISABLE_OPTIMIZATION
void ANewBlueprint4_C__pf3696703102::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ANewBlueprint4_C__pf3696703102::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{57, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  StaticMesh /Game/StarterContent/Props/SM_Statue.SM_Statue 
	};
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ANewBlueprint4_C__pf3696703102::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ANewBlueprint4_C__pf3696703102
{
	FRegisterHelper__ANewBlueprint4_C__pf3696703102()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/res/NewBlueprint4"), &ANewBlueprint4_C__pf3696703102::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ANewBlueprint4_C__pf3696703102 Instance;
};
FRegisterHelper__ANewBlueprint4_C__pf3696703102 FRegisterHelper__ANewBlueprint4_C__pf3696703102::Instance;

...
{
    public enum ShapeType { HyperSphere, HyperCube, DuoCylinder, plane, Cone,FiveCell, SixteenCell, Mandelbrot ,ObjectN1, Pipis, PipisN2, AbstractPlane,infinityCilinder, none, tarelkaloop, cubeLine};

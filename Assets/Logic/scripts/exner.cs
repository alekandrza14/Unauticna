...
public class exner : MonoBehaviour
{
    ...
    void Update()
    {
        transform.Rotate(new Vector3(0, Random.Range(-1030, 1031) * Time.deltaTime, 0));
        transform.Translate(new Vector3(20 * Time.deltaTime, Random.Range(-13, 14) * Time.deltaTime,0));
    }
}

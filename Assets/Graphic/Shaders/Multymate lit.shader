Shader "Multymate Rneder Pipline/Multymate Lit"
{
    Properties
    {
        ...
        SubShader
        {
            ...
            v2f vert(appdata v)
            {
                ...
                if (o.diffuse.r + o.diffuse.g + o.diffuse.b + o.diffuse.a < _Ambient) o.diffuse = float4(_Ambient/3, _Ambient / 3, _Ambient / 3, 0)-.1;
                return o;
            }
            ...
            fixed4 col1 = tex2D(_MainTex, i.uv);
              ...
              if(_LightColor.r + _LightColor.g + _LightColor.b <= 0) col *= (i.diffuse);
             ...
             if((_LightColor.r+ _LightColor.b + _LightColor.g) >0.5)  c *= _BrightColor*10;
             c += Fract(i.uv);
               return c;
            }
        ENDCG

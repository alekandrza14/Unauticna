Shader "Unauticna Multiverse Customs/Low UnLit Shaders/Multyverse Chaos Raymarching-Material Shader/Skybox"
{
    Properties
    {
            ...
            }float Depth(float3 pos)
{
    ...
    return clipPos.z / clipPos.w;
            ...
            fixed4 frag(v2f i,out float outDepth : SV_Depth) : SV_Target
            {
                ...
                else discard;if(_Depth == 0) {  outDepth = Depth(float3(10000000,10000000,10000000));}else{

Shader "Ray Marching/Mandelbulb"
{
    Properties
    {
        ...
        _Brigtness ("Brigtness", Float) = 0
        _OnShadows("NoRenederShadows", int) = 1
    ...
    CGINCLUDE
        ...
        float SDF(float3 pos)
        {
            ...
            return max((_Scale * 0.5 * log(r) * r / dr),(Sphere(pos, 0, _CutScale)*_Scale));
        }
    ENDCG
